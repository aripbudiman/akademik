...
export default function Edit({ errors, flash, siswa, kelas, mapel, absensi }) {
    ...
    const update = (e) => {
        e.preventDefault()
        router.post(`/absensi/${absensi.id}/update`, values, {
            onSuccess: () => {
                Swal.fire({
                    icon: 'success',
                    title: 'Success',
        ...
        <App title="Isi Absensi">
            ...
            <div className='mt-5 xl:w-1/2 w-full'>
                ...
                <div className='mt-5 flex gap-x-3'>
                    <button onClick={update} className='btn btn-primary'>Simpan</button>
