...
export default function Edit({ flash, siswa, errors, pembayaran }) {
    const url = import.meta.env.VITE_URL;
    const [foto, setFoto] = useState(null);
    const [previewFoto, setPreviewFoto] = useState(
        url + "/storage/" + pembayaran.foto
    );
    ...
    const submit = (e) => {
        e.preventDefault();
        router.post(`/pembayaran/${pembayaran.id}/update`, values, {
            onSuccess: () => {
                Swal.fire({
                    icon: "success",
                    title: "Success",
